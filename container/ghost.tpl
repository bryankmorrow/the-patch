...
<div class="col-md-12">
<div style="display: inline-block; float: right;margin-top:-10px;margin-right: -20px;">
    <img src="https://g3t.dev/static/images/ghost-ws.png"/>
</div>
...
<script>
    ...
    let setup = () => {
        ...
        document.getElementById("size").innerHTML = scan_result[0].Manifest.config.size
    }
...
<script src="https://cdn.jsdelivr.net/npm/@g3t/pumpkin@0.0.2/pumpkin.min.js"></script>
